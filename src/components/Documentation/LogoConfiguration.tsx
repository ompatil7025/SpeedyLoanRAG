        ...
        <>
            ...
            <div className="p-6 rounded-md border mt-4 border-border dark:border-dark_border">
                <p className="text-base font-medium text-SlateBlueText dark:text-opacity-80 flex lg:flex-row flex-col">
                    1. Replace Speedy Loan Finance Services logo from:
                ...
                <div className="py-4 px-3 rounded-md bg-black mt-8">
                    <div className="text-sm text-gray-400">
                        ...
                        <p className="ms-3">src=&#x22;/images/logo/speedy-loan-logo.svg&#x22;</p>
                        <p className="ms-3">alt=&#x22;Speedy Loan Logo&#x22;</p>
                        ...
                        <p className="ms-2">&#x3C;Image</p>
                        <p className="ms-5">src=&#x22;/images/logo/speedy-loan-logo-white.svg&#x22;</p>
                        <p className="ms-5">alt=&#x22;Speedy Loan Logo&#x22;</p>
