            ...
            <section className="dark:bg-darkmode lg:pt-20 pt-16 lg:pb-24 pb-10">
                <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md">
                        ...
                        <div className="flex sm:flex-row flex-col items-start sm:gap-8 gap-4">
                            ...
                            <div className="flex md:flex-col sm:flex-row flex-col md:items-start sm:items-center items-start h-full justify-between">
                                <div>
                                    ...
                                    <p className="text-SlateBlueText font-normal text-xl max-w-80 pt-3 pb-7 dark:text-opacity-80">
                                        Join Speedy Loan Finance Services and grow your career in the finance industry while making a real impact on people’s lives.
                                    </p>
                    ...
                    <div className="md:pt-28 pt-11 md:pb-28 pb-16">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3780.836028155063!2d73.7920!3d18.6394!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2b954f100539d%3A0xe870a970514b522c!2sMayur%20Trade%20Center!5e0!3m2!1sen!2sin!4v1704300000000"
                            width="100%"
                            height="477"
                            style={{ border: 0 }}
                            allowFullScreen
