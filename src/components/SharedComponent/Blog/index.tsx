        ...
        <section className="flex flex-wrap justify-center py-24 dark:bg-darklight border-t border-border dark:border-dark_border " id="blog">
            <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md">
                <div className="flex items-baseline justify-between flex-wrap">
                    ...
                    <Link href="/blog" className="flex items-center gap-3 text-base text-SlateBlueText dark:text-white hover:dark:text-primary font-medium hover:text-primary sm:pb-0 pb-3" data-aos="fade-left" data-aos-delay="200" data-aos-duration="1000">
                        View More
                        <span>
                            <Icon
